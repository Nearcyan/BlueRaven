  ...
  hideElements: {
    ...
    floatingChatButton: {
      ...
      selectors: [
        ...
        'button[data-testid="chat-drawer-main"]',
        ...
        'div[style*="position: fixed"][style*="bottom: 0"]:has(div[data-testid="chat-drawer-root"])',
        'div[style*="position: absolute"][style*="bottom: 0"]:has(div[data-testid="chat-drawer-root"])',
        'div[style*="position: fixed"][style*="bottom: 0"]:has(button[data-testid="chat-drawer-main"])',
        'div[style*="position: absolute"][style*="bottom: 0"]:has(button[data-testid="chat-drawer-main"])',
